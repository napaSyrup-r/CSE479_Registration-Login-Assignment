...
<div class="glass-card">
    <div class="card-header">
        ...
        <div class="card-subtitle">Create your account to get started</div>
    </div>
    ...
    <form action="register.php" method="POST">
        <div class="field-group">
            ...
            <input class="field-input" type="text" name="fullname" placeholder="Enter your full name" required>
        </div>
		...
		<div class="field-group">
            ...
            <input class="field-input" type="text" name="address" placeholder="Your address" required>
        </div>

        <div class="field-grid">
            <div class="field-group">
                <div class="field-label">Phone</div>
                <input class="field-input" type="text" name="phone" placeholder="01XXXXXXXXX" required>
            </div>

            <div class="field-group">
                <div class="field-label">Password</div>
                <input class="field-input" type="password" name="password" placeholder="Choose a password" required>
            </div>
        </div>
